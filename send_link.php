...
if (!$select->execute()) 
{
  ...
  if($select->num_rows==1)
  {
	...
	//Addtional Headers
	$headers .= 'From: Pi Face Recognition <pifacerecognitionsystem@gmail.com>' . "\r\n";
	...
	$msg .='<p> </p>';
	$msg .='<a href= "ec2-52-207-254-139.compute-1.amazonaws.com/reset.php?key=$email&reset=$password">Click Here To Reset Password </a>';
	$msg .='<p> </p>';
	$msg .='<p>Thank you</p>';
	$msg .='<p>Pi Face Recognition</p>';
	$msg .= '</body></html>';
